...
},
{
  ...
  "number": "2.4",
  "title": "線形写像としての行列",
  "body": " 線形写像としての行列   写像としての行列  行列は 次元数ベクトルを 次元数ベクトルへ写す写像(関数) であると考えることができる。   写像 としての行列   行列 を 次元数ベクトル に作用させた結果得られる 次元数ベクトルは以下のように定義される。   言い換えると、 である。   このようにして 行列 は という写像を定義する。    行列が表す写像の線形性   線形写像   写像 が    を満たすとき 線形写像 という。      任意の行列 について、写像 は線形写像である。    任意の と について  任意の について     線形性の条件   写像 について以下は同値   は線形写像。              に関する帰納法で証明する。まずは の場合を証明する。 次に    の場合を考えることで、  の場合を考えることで、    この線形性こそが行列の本質であり、線型写像は行列と同一視できることを次の章で示す。   "
},
{
  "id": "def-mat-vec",
  "level": "2",
  ...
  "body": " 写像 としての行列   行列 を 次元数ベクトル に作用させた結果得られる 次元数ベクトルは以下のように定義される。   言い換えると、 である。  "
},
{
...
},
{
  ...
  "number": "2.8.4",
  "title": "線形写像の合成写像.",
  "body": " 線形写像の合成写像  任意の と と について    より、  よって より、 が成り立つ。一方で より、任意の について が成り立つ。  ここで二つの から への写像 は線型写像である(一つ目は行列を掛ける写像 なので線型写像、二つ目は線型写像の合成 なので より線型写像)。 よって標準ベクトルの行き先のみによって写像は定まる。 この二つの線形写像は標準ベクトルの行き先が等しいので、 である。   "
},
{
...
},
{
  ...
  "body": " 日後の天気  天気が晴れ、雨、曇りの三種類であるとし、ある日の天気は前日の天気から確率的に定まると仮定する。 二日以上前の天気には依存しないと仮定する。 ある日の天気が晴れのとき、次の日の天気が晴れ、雨、曇りの確率はそれぞれ とする。 ある日の天気が雨のとき、次の日の天気が晴れ、雨、曇りの確率はそれぞれ とする。 ある日の天気が曇りのとき、次の日の天気が晴れ、雨、曇りの確率はそれぞれ とする。  ある日の天気が晴れ、雨、曇りの確率が であるとする。 このとき 日後の天気が晴れ、雨曇りの確率を とすると 任意の について が成り立つ。  よって 日後の天気の確率分布は と計算できる。  "
},
{
  "id": "sec-graph",
  "level": "1",
...
},
{
  ...
  "number": "4.1",
  "title": "線形空間",
  "body": " 線形空間   線形空間と部分空間   が以下の条件を満すとき、 を 線形空間 であるという。  .  .   線形空間 が を満すとき は の 部分空間 であるという。    は線形空間であり、 の部分空間である。 また、 も線形空間であり、 の部分空間である。 これらは の 自明な部分空間 という。   線形空間と部分空間の例   任意の について は線形空間であり、 の部分空間である。  任意の について は線形空間であり、 の部分空間である。  は線形空間であり、 の部分空間である。     スパン   任意の について、 と定義する。 これを のスパン もしくは が貼る線形空間(部分空間) という。 また、 と定義する。    "
},
{
  "id": "sec-subspace-2",
  "level": "2",
  "url": "sec-subspace.html#sec-subspace-2",
  "type": "定義",
  "number": "4.1.1",
  "title": "線形空間と部分空間.",
...
},
{
  "id": "sec-subspace-3",
  "level": "2",
  "url": "sec-subspace.html#sec-subspace-3",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
  "body": "自明な部分空間 "
},
{
  "id": "sec-subspace-4",
  "level": "2",
  "url": "sec-subspace.html#sec-subspace-4",
  "type": "例",
  "number": "4.1.2",
  "title": "線形空間と部分空間の例.",
...
},
{
  "id": "sec-subspace-5",
  "level": "2",
  "url": "sec-subspace.html#sec-subspace-5",
  "type": "定義",
  "number": "4.1.3",
  "title": "スパン.",
  "body": " スパン   任意の について、 と定義する。 これを のスパン もしくは が貼る線形空間(部分空間) という。 また、 と定義する。   "
},
{
  "id": "sec-linear-ind",
  "level": "1",
  ...
  "number": "4.2",
  "title": "線形独立性",
  "body": " 線形独立性  スパンを使って の部分空間を表すことができるが、その際にベクトルが冗長になる場合もある。 例えば において、 であり、三つめのベクトルは冗長となる。  冗長性を持たないベクトルの集合の性質を線形独立性として定義する。   線形独立性   本の数ベクトル が 線形独立 であるとは が成り立つことをいう。 空集合( の場合)も線形独立であるという。  線形独立でないベクトル集合を 線形従属 であるという。     線形独立性の例   が線形独立 .  が線形独立 を満たす が存在しない。  は線形独立。  は線形従属。  ベクトルの集合 が線形独立  の部分集合は線形独立。  \\end{example}    について、 が線形独立である 任意の について、 を満たす は唯一。    は自明。  を示す。 ある が を満たすと仮定する。 が成り立つ。 は線形独立なので、 が成り立つ。     について は線形従属。   "
},
{
  "id": "sec-linear-ind-4",
  "level": "2",
  "url": "sec-linear-ind.html#sec-linear-ind-4",
  "type": "定義",
  "number": "4.2.1",
  "title": "線形独立性.",
  "body": " 線形独立性   本の数ベクトル が 線形独立 であるとは が成り立つことをいう。 空集合( の場合)も線形独立であるという。  線形独立でないベクトル集合を 線形従属 であるという。   "
},
{
  "id": "sec-linear-ind-5",
  "level": "2",
  "url": "sec-linear-ind.html#sec-linear-ind-5",
  "type": "例",
  "number": "4.2.2",
  "title": "線形独立性の例.",
  "body": " 線形独立性の例   が線形独立 .  が線形独立 を満たす が存在しない。  は線形独立。  は線形従属。  ベクトルの集合 が線形独立  の部分集合は線形独立。  \\end{example} "
},
{
  "id": "sec-linear-ind-6",
  "level": "2",
  "url": "sec-linear-ind.html#sec-linear-ind-6",
  "type": "補題",
  "number": "4.2.3",
  "title": "",
  "body": "  について、 が線形独立である 任意の について、 を満たす は唯一。    は自明。  を示す。 ある が を満たすと仮定する。 が成り立つ。 は線形独立なので、 が成り立つ。   "
},
{
  "id": "sec-linear-ind-7",
  "level": "2",
  "url": "sec-linear-ind.html#sec-linear-ind-7",
  "type": "系",
  "number": "4.2.4",
  "title": "",
  "body": " について は線形従属。  "
},
{
  ...
  "number": "4.3",
  "title": "基底",
  "body": " 基底  線形独立なベクトルの集合の要素に順序がついていると便利なので、順序付きの集合としてリストを導入する。   リスト   について、ベクトルの列 をベクトルの リスト という。 括弧を省略して と表すこともある。      リスト が線形従属 ある が存在して、 .    は自明。 を示す。  が線形従属であることから、「すべて0」ではない が存在して  を である最大のものとすると、 よって、      任意の について    は自明。 を示す。   は自明なので を示せばよい。  仮定より を満たす が存在する。  任意の について、 を満たす が存在する。 %  よって 。      について、 に含まれる線形独立集合のサイズは高々 である。    とおく。 が線形独立であると仮定する。 このとき、 を示せばよい。    for :  　       を の部分空間であるとする。 数ベクトル と がそれぞれ線形独立であり とする。 このとき、ある が存在し、 は線形独立である。    "
},
{
  "id": "sec-basis-3",
  "level": "2",
  "url": "sec-basis.html#sec-basis-3",
  "type": "定義",
  "number": "4.3.1",
  "title": "リスト.",
...
},
{
  "id": "sec-basis-4",
  "level": "2",
  "url": "sec-basis.html#sec-basis-4",
  "type": "補題",
  "number": "4.3.2",
  "title": "",
  "body": "  リスト が線形従属 ある が存在して、 .    は自明。 を示す。  が線形従属であることから、「すべて0」ではない が存在して  を である最大のものとすると、 よって、   "
},
{
  "id": "sec-basis-5",
  "level": "2",
  ...
  "number": "4.3.3",
  "title": "",
  "body": "  任意の について    は自明。 を示す。   は自明なので を示せばよい。  仮定より を満たす が存在する。  任意の について、 を満たす が存在する。 %  よって 。   "
},
{
  "id": "sec-basis-6",
  "level": "2",
  "url": "sec-basis.html#sec-basis-6",
  "type": "補題",
  "number": "4.3.4",
  "title": "",
  "body": "  について、 に含まれる線形独立集合のサイズは高々 である。    とおく。 が線形独立であると仮定する。 このとき、 を示せばよい。    for :  　    "
},
{
  "id": "sec-basis-7",
  "level": "2",
  ...
  "number": "4.3.5",
  "title": "",
  "body": "  を の部分空間であるとする。 数ベクトル と がそれぞれ線形独立であり とする。 このとき、ある が存在し、 は線形独立である。   "
}
]
