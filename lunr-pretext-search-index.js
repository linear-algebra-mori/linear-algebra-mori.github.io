...
},
{
  ...
  "number": "2.8.4",
  "title": "線形写像の合成写像.",
  "body": " 線形写像の合成写像  任意の と と について    より、  よって より、 が成り立つ。一方で より、任意の について が成り立つ。  ここで二つの から への写像 は線型写像である(一つ目は行列を掛ける写像なので線型写像、二つ目は線型写像の合成なので より線型写像)。 よって標準ベクトルの行き先のみによって写像は定まる。 この二つの線形写像は標準ベクトルの行き先が等しいので、 である。   "
},
{
...
},
{
  ...
  "body": " 日後の天気  天気が晴れ、雨、曇りの三種類であるとし、ある日の天気は前日の天気から確率的に定まると仮定する。 二日以上前の天気には依存しないと仮定する。 ある日の天気が晴れのとき、次の日の天気が晴れ、雨、曇りの確率はそれぞれ とする。 ある日の天気が雨のとき、次の日の天気が晴れ、雨、曇りの確率はそれぞれ とする。 ある日の天気が曇りのとき、次の日の天気が晴れ、雨、曇りの確率はそれぞれ とする。  ある日の天気が晴れ、雨、曇りの確率が であるとする。 このとき 日後の天気が晴れ、雨曇りの確率を とすると 任意の について が成り立つ。  よって 日後の天気は と計算できる。  "
},
{
  "id": "sec-graph",
  "level": "1",
...
},
{
  ...
  "number": "4.1",
  "title": "線形空間",
  "body": " 線形空間   線形空間と部分空間   が以下の条件を満すとき、 を 線形空間 であるという。  .  .   線形空間 が を満すとき は の 部分空間 であるという。     線形空間と部分空間の例   は線形空間であり、 の部分空間である。  は線形空間であり、 の部分空間である。  任意の について は線形空間であり、 の部分空間である。  任意の について は線形空間であり、 の部分空間である。     スパン   任意の について、 と定義する。    "
},
{
  "id": "sec-subspace-2",
  "level": "2",
...
},
{
  ...
  "number": "4.1.2",
  "title": "線形空間と部分空間の例.",
  "body": " 線形空間と部分空間の例   は線形空間であり、 の部分空間である。  は線形空間であり、 の部分空間である。  任意の について は線形空間であり、 の部分空間である。  任意の について は線形空間であり、 の部分空間である。   "
},
{
  "id": "sec-subspace-4",
  "level": "2",
